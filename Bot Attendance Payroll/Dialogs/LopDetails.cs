    ...
    public class LopDetails : IDialog<object>
    {
        ...
        private async Task Halfdays(IDialogContext context, IAwaitable<object> result)
        {
            ...
            try
            {
                ...
                {
                    await context.PostAsync($"Your Lop in payroll month {DimattendancemonthlyDetails.ResponseJSON.PayrollMonth}" +
                    $" are {DimattendancemonthlyDetails.ResponseJSON.LOP_Absent} ");
