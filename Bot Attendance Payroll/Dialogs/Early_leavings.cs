    ...
    public class Early_leavings : IDialog<object>
    {
        ...
        private async Task Halfdays(IDialogContext context, IAwaitable<object> result)
        {
            ...
            try
            {
                ...
                {
                    await context.PostAsync($"Your Early leavings in payroll month {DimattendancemonthlyDetails.ResponseJSON.PayrollMonth}" +
                    $" are {DimattendancemonthlyDetails.ResponseJSON.EarlyLeaving} ");
